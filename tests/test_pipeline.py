...
from papernews.models import RawDocument, ArticleChunk, LLMArticleSelection, LLMArticleSummary, Telemetry

from papernews.core.router import llm_select_article, llm_summarize_article, llm_format_body
...
def test_llm_select_article(test_db, mocker):
    ...
    mocker.patch('papernews.core.router.get_run_logger', return_value=mocker.MagicMock())
    ...
    mocker.patch('papernews.core.router.client.models.generate_content', return_value=mock_response)
...
def test_llm_summarize_article(test_db, mocker):
    ...
    assert test_db.get_cache("summary_test_rss") == '{"summary": "A Python and AI test."}'
